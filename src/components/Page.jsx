...
const PAGE_HEIGHT = 1.81; //6:8.5 OR 12 : 17
...
//Adding Skin Weights and Indices to the Page Geometry
...
export default function Page({ number, front, back, page, opened, bookClosed, ...props }) {
    ...
    const manualSkinnedMesh = useMemo(() => {
        ...
        for (let i = 0; i <= PAGE_SEGMENTS; i++) {
            ...
            if (i > 0) {
                bones[i - 1].add(bone) // attaching new bone to previous bone
        ...
        //Adding materials and colors to each of the six sides of pages
    ...
    useFrame((_, delta) => {
        ...
        skinnedMeshRef.current.material[4].emissiveIntensity =
            ...
            MathUtils.lerp(skinnedMeshRef.current.material[4].emissiveIntensity,
                emissiveIntensity,
                0.1
            )
